...
async function test_unit() {
    ...
    var q = baseurl;
    q = q.replace('{{FUZZ}}', encodeURIComponent(encodeURIComponent(String.fromCharCode(ascii))));
    ...
    try {
        ...
        if (responseBody.indexOf('scobar,') > -1) {
            ...
            appendToFile('okpayloads-url-encode-dup.txt', (ascii - 1) + ' : ' + String.fromCharCode(ascii-1) + '\n');
            //return;
            await delay(10000);
            await test_unit();
        }
